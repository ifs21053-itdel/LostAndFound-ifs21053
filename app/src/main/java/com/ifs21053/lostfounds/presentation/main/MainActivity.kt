package com.ifs21053.lostfounds.presentation.main
...
import com.ifs21053.lostfounds.adapter.LostFoundsAdapter
import com.ifs21053.lostfounds.data.remote.MyResult
import com.ifs21053.lostfounds.databinding.ActivityMainBinding
import com.ifs21053.lostfounds.helper.Utils.Companion.observeOnce
                        ...
                        when (it) {
                            is MyResult.Error -> {
                                if (isChecked) {
                                    Toast.makeText(
                                        this@MainActivity,
                                        "Gagal menyelesaikan lost found: " + todo.title,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                } else {
                                    Toast.makeText(
                                        this@MainActivity,
                                        "Gagal batal menyelesaikan lost found: " + todo.title,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                }
                            }
                            ...
                            is MyResult.Success<*> -> {
                                if (isChecked) {
                                    Toast.makeText(
                                        this@MainActivity,
                                        "Berhasil menyelesaikan lost found: " + todo.title,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                } else {
                                    Toast.makeText(
                                        this@MainActivity,
                                        "Berhasil batal menyelesaikan lost found: " + todo.title,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                }
                            }
